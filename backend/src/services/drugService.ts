...
export class DrugService {
   ...
   * Demo data based on WHO prequalified biologics, Ghana FDA guidance,
   * and international NRA sources. Intended only for prototype/demo, not clinical deployment.
   */
  async seedDrugs() {
    ...
    // ========================================
    const brandDrugs = [
      // Adalimumab - Anti-TNF (WHO prequalified reference biologic)
      {
        name: 'Humira',
      ...
      // Infliximab - Anti-TNF (reference biologic)
      {
        name: 'Remicade',
        type: 'BRAND' as DrugType,
        costPerMonth: 4500,
      ...
      // Etanercept - Anti-TNF (reference biologic)
      {
        name: 'Enbrel',
        type: 'BRAND' as DrugType,
        costPerMonth: 4944,
      ...
      // Trastuzumab - HER2 (WHO prequalified reference biologic)
      {
        name: 'Herceptin',
        type: 'BRAND' as DrugType,
        costPerMonth: 4500,
        ...
        description: 'WHO prequalified HER2-targeted therapy for HER2-positive breast cancer and gastric cancer',
      ...
      // Filgrastim - G-CSF (reference biologic)
      {
        name: 'Neupogen',
        type: 'BRAND' as DrugType,
        costPerMonth: 3500,
      ...
      // Rituximab - Anti-CD20 (WHO prequalified, NHIS 2025 listed)
      {
        name: 'MabThera',
        type: 'BRAND' as DrugType,
        costPerMonth: 6900,
        ...
        manufacturer: 'Roche',
        description: 'WHO prequalified anti-CD20 biologic for NHL/CLL and autoimmune indications. Listed on Ghana NHIS 2025.',
        activeIngredient: 'rituximab',
        blaNumber: 'WHO-PQ / NHIS-LISTED',
        fdaApprovalDate: new Date('1997-11-26'),
        interchangeability: 'NOT_APPLICABLE' as InterchangeabilityStatus,
        indications: 'Non-Hodgkin Lymphoma, CLL, Rheumatoid Arthritis',
        administrationRoute: 'Intravenous infusion',
      },
      // Ranibizumab - Anti-VEGF (reference biologic)
      {
        name: 'Lucentis',
        type: 'BRAND' as DrugType,
        costPerMonth: 4800,
      ...
      // Epoetin alfa - Erythropoietin (reference biologic)
      {
        name: 'Eprex',
        type: 'BRAND' as DrugType,
        costPerMonth: 420,
    ...
    const biosimilars = [
      // ---- ADALIMUMAB (Humira) Biosimilars (examples) ----
      {
        ...
        therapeuticClass: 'TNF-Blocker',
        manufacturer: 'Amgen Inc.',
        description: 'Example adalimumab biosimilar with interchangeability designation; WHO prequalified pathway eligible.',
        activeIngredient: 'adalimumab-atto',
        fdaSuffix: '-atto',
        blaNumber: 'NRA-REF-761024',
      ...
      },
      {
        ...
        description: 'Citrate-free adalimumab biosimilar with interchangeability designation; WHO prequalified pathway eligible.',
        activeIngredient: 'adalimumab-bwwd',
        fdaSuffix: '-bwwd',
        blaNumber: 'NRA-REF-761059',
      ...
      },
      {
        ...
        description: 'Adalimumab biosimilar from Sandoz with interchangeability designation; WHO prequalified pathway eligible.',
        activeIngredient: 'adalimumab-adaz',
        fdaSuffix: '-adaz',
        blaNumber: 'NRA-REF-761071',
      ...
      // ---- INFLIXIMAB (Remicade) Biosimilars (examples) ----
      {
        ...
        description: 'First infliximab biosimilar approved by a reference NRA; WHO prequalified pathway eligible.',
        activeIngredient: 'infliximab-dyyb',
        fdaSuffix: '-dyyb',
        blaNumber: 'NRA-REF-125544',
      ...
      },
      {
        ...
        description: 'Infliximab biosimilar approved for all reference indications by a reference NRA.',
        activeIngredient: 'infliximab-abda',
        fdaSuffix: '-abda',
        blaNumber: 'NRA-REF-761054',
      ...
      // ---- TRASTUZUMAB (Herceptin) Biosimilars (examples) ----
      {
        ...
        description: 'First trastuzumab biosimilar for HER2-positive cancers approved by a reference NRA; WHO prequalified pathway eligible.',
        activeIngredient: 'trastuzumab-dkst',
        fdaSuffix: '-dkst',
        blaNumber: 'NRA-REF-761074',
      ...
      },
      {
        ...
        therapeuticClass: 'HER2-Blocker',
        manufacturer: 'Amgen Inc.',
        description: 'Trastuzumab biosimilar approved based on comprehensive comparative data by a reference NRA.',
        activeIngredient: 'trastuzumab-anns',
        fdaSuffix: '-anns',
        blaNumber: 'NRA-REF-761073',
      ...
      // ---- ETANERCEPT (Enbrel) Biosimilars (examples) ----
      {
        name: 'Erelzi',
        type: 'BIOSIMILAR' as DrugType,
        costPerMonth: 3800,
        ...
        therapeuticClass: 'TNF-Blocker',
        manufacturer: 'Sandoz Inc.',
        description: 'Etanercept biosimilar approved by a strict NRA for all reference indications.',
        activeIngredient: 'etanercept-szzs',
        fdaSuffix: '-szzs',
        blaNumber: 'NRA-REF-761042',
        fdaApprovalDate: new Date('2016-08-30'),
        interchangeability: 'BIOSIMILAR' as InterchangeabilityStatus,
        referenceProductId: createdBrands['etanercept'].id,
        indications: 'Rheumatoid Arthritis, Polyarticular Juvenile Idiopathic Arthritis, Psoriatic Arthritis, Ankylosing Spondylitis, Plaque Psoriasis',
        administrationRoute: 'Subcutaneous injection',
      },
      {
        ...
        therapeuticClass: 'TNF-Blocker',
        manufacturer: 'Samsung Bioepis',
        description: 'Etanercept biosimilar approved for all reference indications by a reference NRA.',
        activeIngredient: 'etanercept-ykro',
        fdaSuffix: '-ykro',
        blaNumber: 'NRA-REF-761046',
        fdaApprovalDate: new Date('2019-04-25'),
        interchangeability: 'BIOSIMILAR' as InterchangeabilityStatus,
        referenceProductId: createdBrands['etanercept'].id,
        indications: 'Rheumatoid Arthritis, Polyarticular Juvenile Idiopathic Arthritis, Psoriatic Arthritis, Ankylosing Spondylitis, Plaque Psoriasis',
        administrationRoute: 'Subcutaneous injection',
